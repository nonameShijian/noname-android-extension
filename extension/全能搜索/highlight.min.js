...
var hljs = function () {
  ...
  function t(e) {
    return _instanceof(e, Map) ? e.clear = e.delete = e.set = function () {
      throw Error("map is read-only");
    } : _instanceof(e, Set) && (e.add = e.clear = e.delete = function () {
  ...
  function V(e) {
    ...
    return e.classNameAliases = s(e.classNameAliases || {}), function n(r, o) {
      ...
      [T, D, F, H].forEach(function (e) {
        return e(r, o);
      }), e.compilerExtensions.forEach(function (e) {
        return e(r, o);
      }), r.__beforeBegin = null, [L, B, P].forEach(function (e) {
        return e(r, o);
      }), r.isCompiled = !0;
      var c = null;
  ...
  var te = function (e) {
    ...
    function E(e, n, r, s) {
      ...
      function h(e, t) {
        return e.scope && "string" == typeof e.scope && M.openNode(y.classNameAliases[e.scope] || e.scope), e.beginScope && (e.beginScope._wrap ? (M.addKeyword(S, y.classNameAliases[e.beginScope._wrap] || e.beginScope._wrap), S = "") : e.beginScope._multi && (u(e.beginScope, t), S = "")), k = Object.create(e, {
          parent: {
            value: k
          }
        }), k;
      ...
      function b(e) {
        ...
        if (!r) return ee;
        var s = k;
        k.endScope && k.endScope._wrap ? (d(), M.addKeyword(t, k.endScope._wrap)) : k.endScope && k.endScope._multi ? (d(), u(k.endScope, e)) : s.skip ? S += t : (s.returnEnd || s.excludeEnd || (S += t), d(), s.excludeEnd && (S = t));
        do {
      ...
      (function () {
        var e = [];
        for (var _t5 = k; _t5 !== y; _t5 = _t5.parent) _t5.scope && e.unshift(_t5.scope);
    ...
    function x(e, n) {
      ...
      var i = function (e) {
        ...
        r = n.filter(v).filter(k).map(function (t) {
          return E(t, e, !1);
        });
      r.unshift(i);
    ...
    for (var _e7 in A) "object" == _typeof(A[_e7]) && n(A[_e7]);
    return Object.assign(e, A), e;
  }({});
  return te;
}();
"object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module && (module.exports = hljs); /*! `javascript` grammar compiled for Highlight.js 11.3.1 */
(function () {
  var e = function () {
    "use strict";
    ...
    return function (o) {
      ...
      var v = [].concat(f, A.contains),
        ...
        I = {
          match: l.concat(/\b/, (k = [].concat(r, ["super"]), l.concat("(?!", k.join("|"), ")")), b, l.lookahead(/\(/)),
